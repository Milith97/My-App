...
const BookMySheet = ({ navigation }) => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <Pressable style={{}} onPress={() => { navigation.navigate('DrawerNav') }}>
                ...
                <Animatable.View style={styles.midleContent} animation='bounceIn'>
                    <View style={styles.btnContainer}>
                        ...
                        <Card style={{ flex: 1, marginTop: '10%', padding: '10%' }}>
                            <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 5,marginBottom:15 }}>
