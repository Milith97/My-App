...
const BusShedule = ({ navigation }) => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            <StatusBar backgroundColor='#COB2B2' />
                        ...
                        <ScrollView style={styles.scrollViewCard}>
                            <View style={styles.cardContent}>
                                <View style={styles.leftContent}>
                                    <Text style={styles.timeText}>9:00 to 11:00</Text>
                                    <Text style={styles.busServiceText}>Red Bus Service</Text>
                                    <Text style={styles.subServiceText}>A/C Big Bus</Text>
                                </View>
                                <View style={styles.rightContent}>
                                    <Text style={styles.priceText}>Rs 1250/-</Text>
                                    <Text style={styles.durationText}>2.5hr</Text>
                                </View>
                            </View>
                        </ScrollView>
