            ...
            <ScrollView >
                <Animatable.View style={styles.midleContent} animation='bounceIn'>
                    <View style={styles.btnContainer}>
                        ...
                        <Card style={{ flex: 1, marginTop: '5%', padding: '3.5%', borderRadius: 10 }}>
                            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', gap: 5, marginBottom: 19 }}>
                                <Text style={styles.text2}>Billing Infomation</Text>
                            </View>
                            <View style={styles.cardContent}>
                                <View style={{ height: 100, gap: 5 }}>
                                    <Text style={{ fontSize: 20, fontWeight: 'bold' }}>Ticket Chargers</Text>
