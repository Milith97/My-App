                        ...
                        <ScrollView style={styles.scrollViewCard}>
                            <View style={styles.cardContent}>
                                <View style={{ flex: 1, height: 150, gap: 5 }}>
                                    <Text style={{ fontSize: 20, fontWeight: 'bold' }}>11:30 to 12:30</Text>
                                    ...
                                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                        ...
                                        <Text style={{ fontSize: 15, color: '#000', marginLeft: 5 }}>54 Seats</Text>
                                    </View>
                                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                ...
                                <View style={{ flex: 1, alignItems: 'flex-end', gap: 10 }}>
                                    <Text style={{ fontSize: 26, fontWeight: 'bold', color: 'black' }}>Rs 750/-</Text>
                                    <Text style={{ fontSize: 20, color: 'black' }}>2.0hr   </Text>
