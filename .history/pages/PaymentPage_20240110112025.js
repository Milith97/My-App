...
const BookMySheet = ({ navigation }) => {
    ...
    const [checked4, setChecked4] = React.useState('fourth');
                    ...
                    <View style={styles.btnContainer}>
                        ...
                        <Card style={{ flex: 1, marginTop: '5%', padding: '3%', borderRadius: 10 }}>
                            ...
                            <View style={{ flex: 1, flexDirection: 'row',alignItems:'center',marginTop:'10%', }}>
                                <RadioButton
                                    value="creditCard"
                                    status={ checked1 === 'first' ? 'checked1' : 'unchecked'}
                            ...
                            <View style={{ flex: 1, flexDirection: 'row',alignItems:'center' }}>
                                <RadioButton
                                    value="creditCard"
                                    status={checked2 === 'second' ? 'checked2' : 'unchecked'}
                            ...
                            <View style={{ flex: 1, flexDirection: 'row',alignItems:'center' }}>
                                <RadioButton
                                    value="creditCard"
                                    status={checked3 === 'third' ? 'checked3' : 'unchecked'}
                            ...
                            <View style={{ flex: 1, flexDirection: 'row',alignItems:'center' }}>
                                <RadioButton
                                    value="creditCard"
                                    status={checked4 === 'fourth' ? 'checked4' : 'unchecked'}
