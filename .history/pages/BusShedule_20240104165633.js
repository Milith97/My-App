                        ...
                        <ScrollView style={styles.scrollViewCard}>
                            <View style={styles.cardContent}>
                                <View style={{ flex: 1 }}>
                                    ...
                                    <Text style={{ fontSize: 14, color: 'gray' }}>A/C Big Bus</Text>
                                </View>
                                {/* Right Content */}
                                <View style={{ flex: 1, alignItems: 'flex-end' }}>
                                    <Text style={{ fontSize: 22, fontWeight: 'bold', color: 'white' }}>Rs 1250/-</Text>
                                    <Text style={{ fontSize: 16, color: 'white' }}>2.5hr</Text>
                                </View>
                            </View>
                        </ScrollView>
