    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <Pressable style={{ margin: 5 }} >
                <Icon2 name="arrow-back-circle" size={46} color="#fff" />
            </Pressable>
            ...
            <ScrollView>
                <Animatable.View style={styles.midleContent} animation='bounceIn'>
                    <View style={styles.btnContainer}>
                        <View style={styles.headerText}>
                            <View>
                                <Text style={styles.text3}> Choes Your Bus </Text>
                            </View>
                            <Text style={styles.text1}>
                                <Text style={styles.text1}> Colombo </Text>
                                <Icon name="arrow-right" size={16} color="#fff" />
...
const styles = StyleSheet.create({
    ...
    headerText: {
        ...
        position: 'absolute',
        zIndex: 2,
        top: 10, // Adjust this value to position the headerText
    },
    midleContent: {
        flex: 2,
        marginTop: '50%', // Adjust this value to your preference
    },
    btnContainer: {
        padding: 20,
    },
