            ...
            <ScrollView >
                <Animatable.View style={styles.midleContent} animation='bounceIn'>
                    <View style={styles.btnContainer}>
                        ...
                        <Card style={{ flex: 1, marginTop: '10%', padding: '3%', borderRadius: 10 }}>
                            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center',}}>
                                <Text style={styles.text2}>Billing Infomation</Text>
                            </View>
                            <View style={styles.cardContent}>
                                <View style={{ height: 100, gap: 5, }}>
                                    <Text style={{ fontSize: 20, fontWeight: 'bold',marginTop: 5,  }}>Ticket Chargers</Text>
                                    <Text style={{ fontSize: 18, marginTop: 5, color: '#BF4925', fontWeight: '700' }}>Converning Fee(3%)</Text>
                                    <Text style={{ fontSize: 18, color: '#000',marginTop: 5,  }}>Grand Tottle</Text>
                                </View>
