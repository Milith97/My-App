                    ...
                    <View style={styles.btnContainer}>
                        ...
                        <Card style={{ flex: 1, marginTop: '5%', padding: '3%', borderRadius: 10 }}>
                            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center',}}>
                                <Text style={styles.text2}>Billing Infomation</Text>
                            </View>
                            <View style={styles.cardContent}>
                                <View style={{ height: 100, gap: 5,}}>
                                    <Text style={{ fontSize: 20, fontWeight: 'bold' ,justifyContent:'space-between' }}>Ticket Chargers</Text>
                                    <Text style={{ fontSize: 18, marginTop: 5, color: '#BF4925', fontWeight: '700',justifyContent:'space-between'  }}>Converning Fee(3%)</Text>
                                    <Text style={{ fontSize: 18, color: '#000',justifyContent:'space-between'  }}>Grand Tottle</Text>
                                </View>
                                ...
                                <View style={{ flex: 1, alignItems: 'flex-end', gap: 5 }}>
                                    <Text style={{ fontSize: 20, fontWeight: 'bold', color: 'black' }}>Rs 1250/-</Text>
                                    <Text style={{ fontSize: 20, color: 'black' }}>Rs 125/-   </Text>
                                </View>
                            </View>
                            {/* <View style={{ flex: 1, }}>
