...
import { useTheme, TextInput, Text, Card } from 'react-native-paper';
...
const styles = StyleSheet.create({
  ...
  midleContent: {
    marginTop: '5%',
    paddingHorizontal: '15%', // Adjust paddingHorizontal as needed
  },
  footer: {
    flex: 1,
  },
  ...
  card: {
    ...
    borderRadius: 10, // Add borderRadius to the card
  },
});
